...
public:
	...
	void accept(const Socket& srv) throw(SocketException, ThreadException);
	void connect(const string& aAddress, uint16_t aPort, bool proxy) throw(SocketException, ThreadException);
