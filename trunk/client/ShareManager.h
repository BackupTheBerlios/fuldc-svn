...
public:
	...
	void refresh(bool dirs = false, bool aUpdate = true, bool block = false, bool incoming = false, bool dir = false, bool init = false) throw(ShareException);
	bool refresh(const string& dir);
	void setIncoming(const string & dir, bool incoming = true);
...
private:
	...
	string refreshDirName;
	StringBoolMap incomingDirs;
