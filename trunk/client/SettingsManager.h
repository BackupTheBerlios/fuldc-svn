...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		SKIPLIST_DOWNLOAD, SKIPLIST_SHARE, WEB_SHORTCUTS, POPUP_FONT, FREE_SLOTS_EXTENSIONS, 
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		STRIP_ISP, STRIP_ISP_PM,HUB_BOLD_TABS, PM_BOLD_TABS, QUEUE_BOLD_TABS, HIGH_PRIO_SAMPLE, ROTATE_LOG,
		POPUP_TIMEOUT, POPUP_AWAY, POPUP_ON_PM, POPUP_ON_NEW_PM, POPUP_ON_HUBSTATUS,
		HUBFRAME_CONFIRMATION, QUEUE_REMOVE_CONFIRMATION, POPUNDER_PM, POPUNDER_DIRLIST,  
		TAB_ACTIVE_BG, TAB_ACTIVE_TEXT, TAB_ACTIVE_BORDER, TAB_INACTIVE_BG, 
		TAB_INACTIVE_TEXT, TAB_INACTIVE_BORDER, TAB_INACTIVE_BG_NOTIFY, TAB_INACTIVE_BG_DISCONNECTED, 
		POPUP_TEXTCOLOR, FREE_SLOTS_SIZE, SHOW_STATUSBAR, SHOW_TOOLBAR, SHOW_TRANSFERVIEW, 
		INT_LAST };
