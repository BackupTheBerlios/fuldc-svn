...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		LOG_FILE_MAIN_CHAT, LOG_FORMAT_MAIN_CHAT,
		LOG_FILE_PRIVATE_CHAT, LOG_FORMAT_PRIVATE_CHAT,
		LOG_FILE_DOWNLOAD, LOG_FORMAT_POST_DOWNLOAD,
		LOG_FILE_UPLOAD, LOG_FORMAT_POST_UPLOAD,
		LOG_FILE_SYSTEM, LOG_FORMAT_SYSTEM,
		LOG_FILE_STATUS, LOG_FORMAT_STATUS, 
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		POPUP_DONT_SHOW_ON_ACTIVE, DUPE_COLOR, DROP_STUPID_CONNECTION, FLASH_WINDOW_ON_PM,
