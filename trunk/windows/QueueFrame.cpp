...
LRESULT QueueFrame::OnCreate(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled)
{
	...
	for(int i = 0; i <COLUMN_LAST; ++i)
		copyMenu.AppendMenu(MFT_STRING, IDC_COPY + i, CSTRING_I(columnNames[i]));
	...
	singleMenu.AppendMenu(MF_POPUP, (UINT)(HMENU)copyMenu, CSTRING(COPY_TO_CLIPBOARD));
	...
	dirMenu.AppendMenu(MF_STRING, IDC_SEARCH_RELEASEALTERNATES, CSTRING(SEARCH_FOR_ALTERNATES));
	...
	dirMenu.AppendMenu(MF_STRING, IDC_NOTIFY, CSTRING(NOTIFY_ME));
